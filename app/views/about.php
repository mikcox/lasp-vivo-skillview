<div style="color:black;">
	...
	<div class="modal-body">
		...
		<br><br>
		This app uses the LASP Extended Metadata Repository (LEMR, built around VIVO) to store and serve data about faculty skills.
		This public version of the application is modifying cached JSON that lives on the server, but the production app is intended
		to eventually push new skill mappings back to the VIVO instance from which the faculty member was pulled.
		<br><br>
		LASP and Brown's personnel information is being served from locally cached JSON files that mimic the results of a query to their internal 
		SPARQL endpoints. UF's personnel information is being generated in real-time from <a href="http://sparql.vivo.ufl.edu">UF's SPARQL endpoint.</a>
		<br><br>
